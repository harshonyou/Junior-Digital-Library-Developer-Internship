...
let Calculator = {
  ...
  function pressedNum(value){
      if(Calculator.waitingForSecond) {
          ...
          Calculator.display = Calculator.display === '0' ? value : Calculator.display + value //Block Display
      }
      upateDisplay(Calculator.display)
  }

  function pressedOps(value) {
      if(Calculator.operation!=null && !Calculator.waitingForSecond && Calculator.firstOperand!=null) {
          pressedEql()
      }
  ...
  function pressedEql() {
      if(Calculator.operation != null) {
        ...
        switch (Calculator.operation) {
            case '+':
                Calculator.firstOperand = Calculator.firstOperand+Calculator.secondOperand
                break;
            case '-':
                Calculator.firstOperand = Calculator.firstOperand-Calculator.secondOperand
                break;
      ...
      <div className="main-location">
        ...
        <div className="info">
          ...
          <p>
            ...
            This is a simple Calculatorulator App created on the second day as an Intern.
            <br/>
